...
public class WCWritable implements WritableComparable<WCWritable>
{
    ...
    public void write(DataOutput out) throws IOException { WritableUtils.writeString(out, this.word); }
    // Mandatory function for Hadoop to know how to read values for this class
    public void readFields(DataInput in) throws IOException { this.word = WritableUtils.readString(in); }
